...
{
    /// <summary>
    /// this is teh info class. is reads information from the simulator.
    /// </summary>
    public class Info
    {
        ...
        private FlightBoardViewModel _flightBoardViewModel;
        /// <summary>
...
/// </summary>
        private Info()
        {
            ...
            parameters.Add("aileron", 0);
            parameters.Add("elevator", 0);
...
/// <returns></returns>
        ...
        {
            return instance ?? (instance = new Info());
        }
/// <summary>
...
/// <param name="data"></param>
        void updateParameters(string data)
        {
            ...
            parameters["aileron"] = prms[19];
            parameters["elevator"] = prms[20];
...
/// </summary>
        ...
        {
            _flightBoardViewModel = FlightBoardViewModel.GetInstance();
